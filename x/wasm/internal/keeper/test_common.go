...
//
//	wasmtypes "github.com/bentaro/nftchain/x/wasm/internal/types"
//)
//
...
//	nh := distribution.NewHandler(nftKeeper)
//	router.AddRoute(nft.RouterKey, nh)
//
//	// Load default wasm config
//	wasmConfig := wasmtypes.DefaultWasmConfig()
//	keeper := NewKeeper(cdc, keyContract, paramsKeeper.Subspace(wasmtypes.DefaultParamspace),
//		accountKeeper, bankKeeper, stakingKeeper, distKeeper, nftKeeper, router, tempDir, wasmConfig,
...
//	res, err := k.Execute(ctx, msg.Contract, msg.Sender, msg.Msg, msg.SentFunds, msg.SentNfts)
//	if err != nil {
//		return nil, err
//	}
//
